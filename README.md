...
Коллекция из шести консольных игр для тренировки мозга. Каждая игра задаёт три вопроса - если ответить на все правильно, игрок побеждает.
...
node bin/brain-divs.js       # сколько делителей у числа?
```
...
**"Сколько делителей у числа?"** - пользователю показывается случайное число. Пользователь должен вычислить количество делителей этого числа.

![brain-divs](screenshots/demo_brain-divs.PNG)
