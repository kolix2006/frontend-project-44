...
const operations = ['+', '-', '*']
const problems = [
  makeProblem(randomizer(20), operations[randomizer(3) - 1], randomizer(20)),
  makeProblem(randomizer(50), operations[randomizer(3) - 1], randomizer(50)),
  makeProblem(randomizer(100), operations[randomizer(3) - 1], randomizer(100)),
]
